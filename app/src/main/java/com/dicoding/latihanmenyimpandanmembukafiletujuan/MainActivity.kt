...
import com.dicoding.latihanmenyimpandanmembukafiletujuan.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(),View.OnClickListener {
    ...
    private fun showList() {
        ...
        builder.setTitle("pilih file yg di inginkan")
    ...
    private fun saveFile(){
        when {
            ...
            binding.editFile.text.toString().isEmpty() ->Toast.makeText(this,"title harus diisi terlebih dahulu",Toast.LENGTH_SHORT).show()
